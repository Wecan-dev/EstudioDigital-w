        ...
        <div class="main-banner__item">
          <div class="main-banner__text">
            ...
            <div class="main-banner__subtitle--serv main-banner__title">
            	...
            	<span> Lorem ipsum dolor sit amet, consetetur</span></p>
          ...
          <div class="main-banner__img">
            <div class="main-banner__img--content">
              <img  src="<?php echo get_template_directory_uri();?>/assets/img/Enmascarar grupo 150.png" alt="">
            </div>
          </div>
...
<section>
	<div class="audiencia-audio creacion">
		<div class="subtitle-general">
	    	<p>La importancia de una marca para tu empredimiento</p>
	    </div>
		<div class="main-audiencia-audio main-aliados">
			...
			<div class="main-audiencia-audio__content">
				<div class="audiencia-audio-content__img">
					<img src="<?php echo get_template_directory_uri();?>/assets/img/Enmascarar grupo 151.png" alt="">
				</div>
			</div>
		</div>
	</div>
...
<section>
	<div class="tools-audio tools-creacion">
		<div class="main-tools-audio padding-rl">
			<div class="main-tools-audio__content">
				<div class="tools-audio-content__icons">
					<div class="tools-audio-content__icons--img">
						<img src="<?php echo get_template_directory_uri();?>/assets/img/Grupo 901.png" alt="">
					</div>
					<div class="tools-audio-content__icons--img">
						<img src="<?php echo get_template_directory_uri();?>/assets/img/Grupo 902.png" alt="">
					</div>
					<div class="tools-audio-content__icons--img">
						<img src="<?php echo get_template_directory_uri();?>/assets/img/Grupo 903.png" alt="">
					</div>
					<div class="tools-audio-content__icons--img">
						<img src="<?php echo get_template_directory_uri();?>/assets/img/Grupo 904.png" alt="">
					</div>
				</div>
			</div>
			<div class="main-tools-audio__content">
